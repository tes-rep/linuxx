...
/*
 * Amlogic sc2 PLL Clock Controller Driver
 *
...
#include <dt-bindings/clock/amlogic,sc2-pll-clkc.h>
...
static const struct of_device_id clkc_match_table[] = {
	{
		.compatible = "amlogic,sc2-pll-clkc",
	},
	{}
};
...
MODULE_DESCRIPTION("Amlogic sc2 PLL Clock Controller driver");
